...
namespace cfg {
constexpr std::string_view kExecEndpoint = "opc.tcp://192.168.212.101:4840";
...
constexpr auto kWorkDwell = 3s; // 工艺点停留时间
...
constexpr double kSafeZ = 3.0;                      // 安全位置的Z高度，单位与IK一致：mm
